...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/benil5zpz-go-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-m9dvt.m9dvt.sandbox3241.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-m9dvt.m9dvt.sandbox3241.opentlc.com}
